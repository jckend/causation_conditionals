...
<p>Press any key to begin.</p>
  ...
  const test_stimuli: Record<string, string>[] = [
    { stimulus1: 'Bob has two risk factors for cardiovascular disease: he smokes and he drinks excessively. However, Bob has lied to his doctor about his drinking. Bob’s doctor tells you: “If Bob doesn’t quit smoking, he’ll get cardiovascular disease.”</p>', prompt1: '<p>Do you think Bob’s doctor would accept the following statement: “If Bob quits smoking, he won’t get cardiovascular disease.”.</p>'},
  ]
