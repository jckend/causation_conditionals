...
export async function runExperiment(updateDebugPanel: () => void): Promise<void> {
  ...
  const test_stimuli: Record<string, string>[] = [
    ...
    { stimulus: imgOff4, prompt: '<p>If the <b>left (&larr;)</b> switch stays <span class="font-semibold text-red-500">on</span>, will the light turn <span class="font-semibold text-yellow-500">on</span>?</p>'},
