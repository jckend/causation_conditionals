...
export async function runExperiment(updateDebugPanel: () => void): Promise<void> {
  ...
  const test_stimuli: Record<string, string>[] = [
    ...
    { stimulus: imgOff2, prompt: '<p>If the <b>right (&rarr;)</b> switch is flipped, will the light turn <span class="font-semibold text-green-500">on</span>?</p>'},
    { stimulus: imgOff2, prompt: '<p>If the <b>right (&rarr;)</b> switch is <b>not</b> flipped, will the light turn <span class="font-semibold text-green-500">on</span>?</p>'},
    { stimulus: imgOff2, prompt: '<p>Will flipping the <b>right (&rarr;)</b> switch make the light turn <span class="font-semibold text-green-500">on</span>?</p>'},
    { stimulus: imgOff2, prompt: '<p>If the <b>left (&larr;)</b> switch is flipped, will the light turn <span class="font-semibold text-green-500">on</span>?</p>'},
    { stimulus: imgOff2, prompt: '<p>If the <b>left (&larr;)</b> switch is <b>not</b> flipped, will the light turn <span class="font-semibold text-green-500">on</span>?</p>'},
    { stimulus: imgOff2, prompt: '<p>Will flipping the <b>left (&larr;)</b> switch make the light turn <span class="font-semibold text-green-500">on</span>?</p>'},
    { stimulus: imgOff3, prompt: '<p>If the <b>right (&rarr;)</b> switch is flipped, will the light turn <span class="font-semibold text-green-500">on</span></p>'},
    { stimulus: imgOff3, prompt: '<p>If the <b>right (&rarr;)</b> switch is <b>not</b> flipped, will the light turn <span class="font-semibold text-green-500">on</span></p>'},
    { stimulus: imgOff3, prompt: '<p>Will flipping the <b>right (&rarr;)</b> switch make the light turn <span class="font-semibold text-green-500">on</span>?</p>'},
    { stimulus: imgOff3, prompt: '<p>If the <b>left (&larr;)</b> switch is flipped, will the light turn <span class="font-semibold text-green-500">on</span></p>'},
    { stimulus: imgOff3, prompt: '<p>If the <b>left (&larr;)</b> switch is <b>not</b> flipped, will the light turn <span class="font-semibold text-green-500">on</span>?</p>'},
    { stimulus: imgOff3, prompt: '<p>Will flipping the <b>left (&larr;)</b> switch make the light turn <span class="font-semibold text-green-500">on</span>?</p>'},
    { stimulus: imgOff4, prompt: '<p>If the <b>right (&rarr;)</b> switch is flipped, will the light turn <span class="font-semibold text-green-500">on</span>?</p>'},
    { stimulus: imgOff4, prompt: '<p>If the <b>right (&rarr;)</b> switch is <b>not</b> flipped, will the light turn <span class="font-semibold text-green-500">on</span>?</p>'},
    { stimulus: imgOff4, prompt: '<p>Will flipping the <b>right (&rarr;)</b> switch make the light turn <span class="font-semibold text-green-500">on</span>?</p>'},
    { stimulus: imgOff4, prompt: '<p>If the <b>left (&larr;)</b> switch is flipped, will the light turn <span class="font-semibold text-green-500">on</span>?</p>'},
    { stimulus: imgOff4, prompt: '<p>If the <b>left (&larr;)</b> switch is <b>not</b> flipped, will the light turn <span class="font-semibold text-green-500">on</span>?</p>'},
    ...
    { stimulus: imgOn2, prompt: '<p>If the <b>right (&rarr;)</b> switch is flipped, will the light turn <span class="font-semibold text-red-500">off</span>?</p>'},
    { stimulus: imgOn2, prompt: '<p>If the <b>right (&rarr;)</b> switch is <b>not</b> flipped, will the light turn <span class="font-semibold text-red-500">off</span>?</p>'},
    { stimulus: imgOn2, prompt: '<p>Will flipping the <b>right (&rarr;)</b> switch make the light turn <span class="font-semibold text-red-500">off</span>?</p>'},
    { stimulus: imgOn2, prompt: '<p>If the <b>left (&larr;)</b> switch is flipped, will the light turn <span class="font-semibold text-red-500">off</span>?</p>'},
    { stimulus: imgOn2, prompt: '<p>If the <b>left (&larr;)</b> switch is <b>not</b> flipped, will the light turn <span class="font-semibold text-red-500">off</span>?</p>'},
    { stimulus: imgOn2, prompt: '<p>Will flipping the <b>left (&larr;)</b> switch make the light turn <span class="font-semibold text-red-500">off</span>?</p>'},
  ]
