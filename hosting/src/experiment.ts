...
export async function runExperiment(updateDebugPanel: () => void): Promise<void> {
  ...
  const test_stimuli: Record<string, string>[] = [
    { stimulus: imgOff1, prompt: '<p>If the switch is flipped, will the light turn <span class="font-semibold text-yellow-500">on</span>?</p>'},
    ...
    { stimulus: imgOff1, prompt: '<p>Will flipping the switch make the light turn <span class="font-semibold text-yellow-500">on</span>?</p>'},
    { stimulus: imgOff2, prompt: '<p>If the <b>right (&rarr;)</b> switch is flipped, will the light turn <span class="font-semibold text-yellow-500">on</span>?</p>'},
    ...
    { stimulus: imgOff2, prompt: '<p>Will flipping the <b>right (&rarr;)</b> switch make the light turn <span class="font-semibold text-yellow-500">on</span>?</p>'},
    { stimulus: imgOff2, prompt: '<p>If the <b>left (&larr;)</b> switch is flipped, will the light turn <span class="font-semibold text-yellow-500">on</span>?</p>'},
    ...
    { stimulus: imgOff2, prompt: '<p>Will flipping the <b>left (&larr;)</b> switch make the light turn <span class="font-semibold text-yellow-500">on</span>?</p>'},
    { stimulus: imgOff3, prompt: '<p>If the <b>right (&rarr;)</b> switch is flipped, will the light turn <span class="font-semibold text-yellow-500">on</span>?</p>'},
    ...
    { stimulus: imgOff3, prompt: '<p>Will flipping the <b>right (&rarr;)</b> switch make the light turn <span class="font-semibold text-yellow-500">on</span>?</p>'},
    { stimulus: imgOff3, prompt: '<p>If the <b>left (&larr;)</b> switch is flipped, will the light turn <span class="font-semibold text-yellow-500">on</span>?</p>'},
    ...
    { stimulus: imgOff3, prompt: '<p>Will flipping the <b>left (&larr;)</b> switch make the light turn <span class="font-semibold text-yellow-500">on</span>?</p>'},
    { stimulus: imgOff4, prompt: '<p>If the <b>right (&rarr;)</b> switch is flipped, will the light turn <span class="font-semibold text-yellow-500">on</span>?</p>'},
    ...
    { stimulus: imgOff4, prompt: '<p>Will flipping the <b>right (&rarr;)</b> switch make the light turn <span class="font-semibold text-yellow-500">on</span>?</p>'},
    { stimulus: imgOff4, prompt: '<p>If the <b>left (&larr;)</b> switch is flipped, will the light turn <span class="font-semibold text-yellow-500">on</span>?</p>'},
    ...
    { stimulus: imgOn1, prompt: '<p>If the switch is flipped, will the light turn <span class="font-semibold text-gray-500">off</span>?</p>'},
    ...
    { stimulus: imgOn1, prompt: '<p>Will flipping the switch make the light turn <span class="font-semibold text-gray-500">off</span>?</p>'},
    { stimulus: imgOn2, prompt: '<p>If the <b>right (&rarr;)</b> switch is flipped, will the light turn <span class="font-semibold text-gray-500">off</span>?</p>'},
    ...
    { stimulus: imgOn2, prompt: '<p>Will flipping the <b>right (&rarr;)</b> switch make the light turn <span class="font-semibold text-gray-500">off</span>?</p>'},
    { stimulus: imgOn2, prompt: '<p>If the <b>left (&larr;)</b> switch is flipped, will the light turn <span class="font-semibold text-gray-500">off</span>?</p>'},
    ...
    { stimulus: imgOn2, prompt: '<p>Will flipping the <b>left (&larr;)</b> switch make the light turn <span class="font-semibold text-gray-500">off</span>?</p>'},
  ]
